...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc" 
  ...
  <p:documentation> This step represents an XProc wrapper for 
    Andrew J. Welch's table normalization algorithm.
  </p:documentation>

  <p:input port="source">
    <p:documentation> Expects a HTML document with tables. </p:documentation>
  </p:input>

  <p:output port="result">
    <p:documentation> The HTML document with normalized tables. </p:documentation>
  </p:output>

  <p:option name="process-tables-only" select="'yes'">
    <p:documentation> Set to 'yes' to saves some time copying nodes that are not required for table normalization
    </p:documentation>
  </p:option>
